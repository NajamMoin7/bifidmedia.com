...
export default function Page() {
  return (
    <section className="simple-page">
      <p className="eyebrow">Template legal content</p>
      <h1>Legal page template for BifidMedia</h1>
      <p>This page contains template content only and must be reviewed by the client and a qualified legal professional before production launch.</p>
      <h2>Scope</h2>
      <p>BifidMedia provides e-commerce, marketplace, advertising, branding, automation, and business development support. No content on this site is legal, tax, financial, or investment advice.</p>
